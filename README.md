...
## Fork comment
The Apache origin version don't support Android M+, so fork the origin verison to support Android M+.
...
```bash
cordova plugin add https://github.com/wlnjtan/cordova-plugin-file-transfer.git
```
